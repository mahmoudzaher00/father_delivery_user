...
class SpecialOrderView extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
   return Scaffold(
     ...
     bottomNavigationBar:  const NewSpecialOrderButtonWidget(),
   );
  }
}

class NewSpecialOrderButtonWidget extends StatelessWidget {
  const NewSpecialOrderButtonWidget({super.key});
